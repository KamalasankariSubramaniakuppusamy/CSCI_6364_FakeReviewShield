...
def main():
    ...
    print("-" * 25)
    log_model = LogisticRegressionScratch(learning_rate=0.1, num_iterations=200)
    ...
    print("-" * 25)
    rf_model = RandomForestScratch(n_trees=200, max_depth=5)
    ...
    print("-" * 25)
    xgb_model = XGBoostScratch(n_estimators=200, learning_rate=0.1)
